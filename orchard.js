...
for (let i = 0; i < 7; i++) {
    fujiTons.push(fujiAcres[i]*acreTons)
    galaTons.push(galaAcres[i]*acreTons)
    pinkTons.push(pinkAcres[i]*acreTons)
}
...
for (let i = 0; i < 7; i++) {
    allFujiTons += fujiTons[i]
    allGalaTons += galaTons[i]
    allPinkTons += pinkTons[i]
}

fujiPounds = allFujiTons*2000
galaPounds = allGalaTons*2000
pinkPounds = allPinkTons*2000
...
console.log(`fujiProfit ${fujiProfit/100}$`)
console.log(`galaProfit ${galaProfit/100}$`)
console.log(`pinkProfit ${pinkProfit/100}$`)
...
console.log(`totalProfit ${totalProfit/100}$`)